...
.sidenav {
	height: 100%;
	background-image: url("${pageContext.request.contextPath}/Images/loginpg.jpg");
...
.main {
	padding: 0px 10px;
	background-image: linear-gradient(98deg,#80aaff,#3333cc);
}
...
<body>
	<div class="sidenav">
		<div class="login-main-text">
			<h2 >
				Portfolio Application<br> Login Page
			</h2>
			<p >Login to Invest and grow !</p>
		</div>
	</div>
	<div class="log">
	<div class="main">
		<div class="col-md-6 col-sm-12">
			<div class="login-form">
				<form action="/login" method="POST" model="userData" name="loginform">
					...
					<div class="text-center d-flex justify-content-between mt-4"><p>${errormsg}</p></div>
				</form>
			</div>
		</div>
	</div>
