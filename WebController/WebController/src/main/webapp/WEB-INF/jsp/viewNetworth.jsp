...
<body>
	<nav class="navbar navbar-dark bg-dark">
		<a class="navbar-brand" href="#" style="margin-left: 20px;"> <img src="${pageContext.request.contextPath}/Images/shares2.jpg" width="30" height="30" class="d-inline-block align-top" alt="">
		...
		<div class="row">
			...
			<div class="col-sm-6 ">
				<div class="card text-center shadow-lg">
					<img class="card-img-top img-fluid" src="${pageContext.request.contextPath}/Images/shares4.jpg"
						style="width: 600x; height: 300px;" alt="">
