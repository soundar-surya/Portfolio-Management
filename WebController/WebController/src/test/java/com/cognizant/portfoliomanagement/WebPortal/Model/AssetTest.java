...
Asset asset=new Asset();
	...
	void testAssetIntStringIntStringInt() {
		Asset asset1=new Asset(1, 11, "101", "MF", 10);
	}
	...
	@Test
	void testToString() {
		Asset asset2=new Asset(1, 11, "101", "MF", 10);
		assertEquals("Asset [tid=0, portfolioid=0, assetid=null, type=null, units=0]",asset.toString());
	}
